...
int warrior_loc(const string& name, const vector<Warrior> &vector_warriors);
...
int main(int argc, const char * argv[]) {
    ...
    //open file warriors.txt to retrieve the commands
    ...
    while(warriors_copy >> command){
        if(command == status){
            ...
            warriors_copy >> warrior_1;
            warriors_copy >> warrior_2;
            ::battle(vector_warriors[warrior_loc(warrior_1, vector_warriors)],
                     vector_warriors[warrior_loc(warrior_2, vector_warriors)]);
        }
    }
    warriors_copy.close();
}
...
void battle(Warrior& warrior_1, Warrior& warrior_2){
    ...
    // case 2: warrior_1 won
        ...
        cout << warrior_1.warrior_name << " defeats "
        << warrior_2.warrior_name << endl;
    ...
    // case 3: warrior_2 won
        ...
        cout << warrior_2.warrior_name << " defeats "
        << warrior_2.warrior_name << endl;
